...
_sc7p5t_rev28_slvt_open_road_pdk_configuration_common = dict(
...
make_open_road_pdk_configuration(
    name = "open_road-asap7-sc7p5t_rev28_slvt-nofa",
    common = _sc7p5t_rev28_slvt_open_road_pdk_configuration_common,
)

make_open_road_pdk_configuration(
    name = "open_road-asap7-sc7p5t_rev28_slvt-fa",
    common = _sc7p5t_rev28_slvt_open_road_pdk_configuration_common,
...
[
    alias(
        name = "open_road-asap7-sc7p5t_rev28_slvt-" + add,
        actual = ":open_road-asap7-sc7p5t_rev28_slvt-fa",
        visibility = ["//visibility:public"],
    )
...
alias(
    name = "open_road-asap7-sc7p5t_rev28_slvt-opt",
    actual = ":open_road-asap7-sc7p5t_rev28_slvt-fa",
    visibility = ["//visibility:public"],
)
