...
_sc7p5t_rev28_lvt_open_road_pdk_configuration_common = dict(
...
make_open_road_pdk_configuration(
    name = "open_road-asap7-sc7p5t_rev28_lvt-nofa",
    common = _sc7p5t_rev28_lvt_open_road_pdk_configuration_common,
)

make_open_road_pdk_configuration(
    name = "open_road-asap7-sc7p5t_rev28_lvt-fa",
    common = _sc7p5t_rev28_lvt_open_road_pdk_configuration_common,
...
[
    alias(
        name = "open_road-asap7-sc7p5t_rev28_lvt-" + add,
        actual = ":open_road-asap7-sc7p5t_rev28_lvt-fa",
        visibility = ["//visibility:public"],
    )
...
alias(
    name = "open_road-asap7-sc7p5t_rev28_lvt-opt",
    actual = ":open_road-asap7-sc7p5t_rev28_lvt-fa",
    visibility = ["//visibility:public"],
)
