...
_sc6t_rev26_lvt_open_road_pdk_configuration_common = dict(
    cell_site = "asap7sc6t",
...
make_open_road_pdk_configuration(
    name = "open_road-asap7-sc6t_rev26_lvt-nofa",
    common = _sc6t_rev26_lvt_open_road_pdk_configuration_common,
)

make_open_road_pdk_configuration(
    name = "open_road-asap7-sc6t_rev26_lvt-fa",
    common = _sc6t_rev26_lvt_open_road_pdk_configuration_common,
...
[
    alias(
        name = "open_road-asap7-sc6t_rev26_lvt-" + add,
        actual = ":open_road-asap7-sc6t_rev26_lvt-fa",
        visibility = ["//visibility:public"],
    )
...
alias(
    name = "open_road-asap7-sc6t_rev26_lvt-opt",
    actual = ":open_road-asap7-sc6t_rev26_lvt-fa",
    visibility = ["//visibility:public"],
)
