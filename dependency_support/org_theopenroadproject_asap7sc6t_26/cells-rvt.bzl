...
""" ASAP7 "rev 26" 6 track standard cell library using regular VT transistors """

# ------------------------------------------------------------------------
asap7_cells_files(
    name = "asap7-cells-sc6t_rev26_rvt",
    rev = "26",
    tracks = "6t",
    vt = "rvt",
)
...
_sc6t_rev26_rvt_open_road_pdk_configuration_common = dict(
    ...
    endcap_cell = "TAPCELL_ASAP7_6t_R",
    fill_cells = [
        "FILLERxp5_ASAP7_6t_R",
        "DECAPx1_ASAP7_6t_R",
        "DECAPx2_ASAP7_6t_R",
        "DECAPx4_ASAP7_6t_R",
        "DECAPx6_ASAP7_6t_R",
...
make_open_road_pdk_configuration(
    name = "open_road-asap7-sc6t_rev26_rvt-nofa",
    common = _sc6t_rev26_rvt_open_road_pdk_configuration_common,
)

make_open_road_pdk_configuration(
    name = "open_road-asap7-sc6t_rev26_rvt-fa",
    common = _sc6t_rev26_rvt_open_road_pdk_configuration_common,
...
[
    alias(
        name = "open_road-asap7-sc6t_rev26_rvt-" + add,
        actual = ":open_road-asap7-sc6t_rev26_rvt-fa",
        visibility = ["//visibility:public"],
    )
...
alias(
    name = "open_road-asap7-sc6t_rev26_rvt-opt",
    actual = ":open_road-asap7-sc6t_rev26_rvt-fa",
    visibility = ["//visibility:public"],
)
